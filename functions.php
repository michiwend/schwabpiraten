...
function yoko() {
	...
	define( 'HEADER_IMAGE_HEIGHT', apply_filters( 'yoko_header_image_height', 150 ) );
...
//			),
			'plant' => array(
			'url' => '%s/images/headers/header-fsa10.jpg',
			'thumbnail_url' => '%s/images/headers/header-fsa10-thumbnail.jpg',
			/* translators: header image description */
			'description' => __( 'FSA 2010', 'yoko' )
			),
//			'sailing' => array(
...
//			),
			'cape' => array(
			'url' => '%s/images/headers/header-bzpt10.jpg',
			'thumbnail_url' => '%s/images/headers/header-bzpt10-thumbnail.jpg',
			/* translators: header image description */
			'description' => __( 'BzPt 2010', 'yoko' )
			),
			'infostand' => array(
			'url' => '%s/images/headers/header-infostand.jpg',
			'thumbnail_url' => '%s/images/headers/header-infostand-thumbnail.jpg',
			/* translators: header image description */
			'description' => __( 'Infostand', 'yoko' )
			),
			'tshirt' => array(
			'url' => '%s/images/headers/header-tshirt.jpg',
			'thumbnail_url' => '%s/images/headers/header-tshirt-thumbnail.jpg',
			/* translators: header image description */
			'description' => __( 'Tshirt', 'yoko' )
			)
	) );
}
endif;
...
$googleplus_title = empty($instance['googleplus_title']) ? ' ' : apply_filters('widget_googleplus_title', $instance['googleplus_title']);
		...
		$diaspora_title = empty($instance['diaspora_title']) ? ' ' : apply_filters('widget_diaspora_title', $instance['diaspora_title']);
		$diaspora_url = empty($instance['diaspora_url']) ? ' ' : apply_filters('widget_diaspora_url', $instance['diaspora_url']);
		$identica_title = empty($instance['identica_title']) ? ' ' : apply_filters('widget_identica_title', $instance['identica_title']);
		$identica_url = empty($instance['identica_url']) ? ' ' : apply_filters('widget_identica_url', $instance['identica_url']);
	...
	if($rss_title == ' ') { echo ''; } else {  echo  '<li class="widget_sociallinks"><a href="'. $rss_url .'" class="rss" target="_blank">'. $rss_title .'</a></li>'; }
		...
		if($diaspora_title == ' ') { echo ''; } else {  echo  '<li class="widget_sociallinks"><a href="'. $diaspora_url .'" class="diaspora" target="_blank">'. $diaspora_title .'</a></li>'; }
		if($identica_title == ' ') { echo ''; } else {  echo  '<li class="widget_sociallinks"><a href="'. $identica_url .'" class="identica" target="_blank">'. $identica_title .'</a></li>'; }
		echo '</ul>';
		echo $after_widget;
	...
	function update($new_instance, $old_instance) {
		...
		$instance['diaspora_title'] = strip_tags($new_instance['diaspora_title']);
		$instance['diaspora_url'] = strip_tags($new_instance['diaspora_url']);
		$instance['identica_title'] = strip_tags($new_instance['identica_title']);
		$instance['identica_url'] = strip_tags($new_instance['identica_url']);
		return $instance;
	}
	function form($instance) {
		...
		$diaspora_title = strip_tags($instance['diaspora_title']);
		$diaspora_url = strip_tags($instance['diaspora_url']);
		$identica_title = strip_tags($instance['identica_title']);
		$identica_url = strip_tags($instance['identica_url']);
?>
			...
			<p><label for="<?php echo $this->get_field_id('diaspora_title'); ?>"><?php _e( 'Diaspora Text:', 'yoko' ); ?> <input class="widefat" id="<?php echo $this->get_field_id('diaspora_title'); ?>" name="<?php echo $this->get_field_name('diaspora_title'); ?>" type="text" value="<?php echo esc_attr($diaspora_title); ?>" /></label></p>
			<p><label for="<?php echo $this->get_field_id('diaspora_url'); ?>"><?php _e( 'Diaspora URL:', 'yoko' ); ?> <input class="widefat" id="<?php echo $this->get_field_id('diaspora_url'); ?>" name="<?php echo $this->get_field_name('diaspora_url'); ?>" type="text" value="<?php echo esc_attr($diaspora_url); ?>" /></label></p>
			<p><label for="<?php echo $this->get_field_id('identica_title'); ?>"><?php _e( 'identi.ca Text:', 'yoko' ); ?> <input class="widefat" id="<?php echo $this->get_field_id('identica_title'); ?>" name="<?php echo $this->get_field_name('identica_title'); ?>" type="text" value="<?php echo esc_attr($identica_title); ?>" /></label></p>
			<p><label for="<?php echo $this->get_field_id('identica_url'); ?>"><?php _e( 'identi.ca URL:', 'yoko' ); ?> <input class="widefat" id="<?php echo $this->get_field_id('identica_url'); ?>" name="<?php echo $this->get_field_name('identica_url'); ?>" type="text" value="<?php echo esc_attr($identica_url); ?>" /></label></p>
