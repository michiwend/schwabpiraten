...
<link rel="shortcut icon" href="/wp-content/themes/schwabpiraten/images/favicon.ico" >
<title><?php
	/*
...
<div id="page" class="clearfix">
	<header id="branding">
		...
		<?php if( $yoko_settings['custom_logo'] ) : ?>
			<div style="float:left;"><a href="<?php echo home_url( '/' ); ?>" class="logo"><img src="<?php echo $yoko_settings['custom_logo']; ?>" alt="<?php bloginfo('name'); ?>" /></a></div>
		<?php else : ?>
