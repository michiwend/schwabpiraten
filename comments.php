...
<?php comment_form(
array(
	'comment_notes_before' =>__( '<p class="comment-notes">Benötigte Felder sind mit einem <span class="required">*</span> markiert. (Email-Adressen werden <strong>nicht</strong> veröffentlicht!)</p>', 'yoko'),
	'comment_notes_after' => '',
